...
describe('helpers:header', () => {
    ...
    test('should parse headers', () => {
      const parsed = parseHeaders(
        'Content-Type: application/json\r\n' +
          ...
          'Date: Tue, 21 May 2019 09:23:33 GMT\r\n' +
          'key:'
      )
      ...
      expect(parsed['date']).toBe('Tue, 21 May 2019 09:23:33 GMT')
  ...
  describe('processHeaders', () => {
    ...
    test('should set Content-Type if not set and dta is PlainObject', () => {
      const headers: any = {}
    ...
    test('should not set Content-Type if not set and data is not PlainObject', () => {
      const headers: any = {}
      processHeaders(headers, new Date())
